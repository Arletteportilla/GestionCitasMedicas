...
class HojaDeVida(rx.Model, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
    medico_id: int = Field(foreign_key="medico.id")
    experiencia: str
    educacion: str

    def __init__(self, medico_id: int, experiencia: str, educacion: str, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class Diagnostico(rx.Model, table=True):
    ...
    def __init__(self, paciente_id: int, medico_id: int, descripcion: str, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class Receta(rx.Model, table=True):
    ...
    def __init__(self, diagnostico_id: int, medicamentos: str, *args, **kwargs):
        super().__init__(*args, **kwargs)
